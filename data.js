...
const I18N = {
  "zh": {
    ...
    "stage_name_2": "2. 完成练习",
    "stage_name_3": "3. 新题验证",
    "stage_select_aria": "掌握阶段",
    "core_summary_label": "考纲核心：",
    "no_match_title": "[无结果]",
    "no_match_desc": "没有找到与「{kw}」或当前筛选条件匹配的考点，请尝试清除搜索词。",
    "suggest_minutes": "建议 {n} 分钟",
    "note_minutes": "{n} 分钟",
    "cal_checked_suffix": " (已打卡)",
    "today_finished_badge": "已达成",
    "today_finished_status": "已完成全部计划",
    "today_finished_title": "恭喜！{n} 天备考计划已全部打卡完成",
    "today_finished_obj": "知识体系已打通！现在进入 Mock 标签页，进行全真模拟测试并针对错因定向回补。",
    "today_finished_out": "完成至少两套 60 题计时 Mock，确保稳定达到 80% 以上！",
    "today_finished_btn": "计划已全部通关",
    "plan_heading_7": "7 天冲刺学习计划",
    "plan_heading_14": "14 天稳妥学习计划",
    "plan_progress_pill": "已完成 {done} / {total} 天",
    "readiness_ready": "已达就绪标准 (2 次以上 80%+)",
    "readiness_progress": "就绪度：{n}/2 次 Mock 达到 80%",
    "readiness_ready_short": "已就绪",
    "latest_mock": "最近 {c}/60 · {m}m",
    "countdown_days": "考期倒计时：还有 {n} 天 ({d})",
    "countdown_today": "今天就是考试日！保持冷静，自信应战！",
    "countdown_passed": "考期已过 ({d})，点击「设置日期」修改",
    "mock_default_source": "计时模拟",
    "mock_meta": "耗时 {m} 分钟 · 最弱：{w}",
    "btn_delete": "删除",
    "mistake_default_qno": "错题",
    "mistake_wrong_tag": "[错误选项]",
    "mistake_right_tag": "[正确选项]",
    "mistake_reflection_tag": "[复盘总结]",
    "mistake_ref_tag": "[回补]",
    "mistakes_filter_empty": "当前分类下暂无错题。在平时的场景练习或 Mock 模拟中遇到错误，点击上方「+ 添加一道错题」记录复盘！",
    "all_count": "全部 ({n})",
    "auto_checkin_note": "完成 Day {n}：{title}",
    "toast_plan_switched": "已切换为 {n} 天学习计划",
    "toast_day_checked": "Day {n} 打卡成功！连续学习 {s} 天",
    "toast_checkin_saved": "已成功记录打卡！连续学习 {s} 天",
    "toast_all_done": "当前计划所有天数均已打卡完成！",
    "toast_mock_saved": "Mock 记录已保存！已实时重算就绪度状态",
    "toast_mistake_saved": "错题已存入笔记本，常复习错因方能真正攻破！",
    "toast_exam_date_set": "已更新目标考期为 {d}",
    "toast_exam_date_cleared": "已清除目标考期",
    "toast_focus_done": "恭喜完成 {n} 分钟专注学习！",
    "confirm_uncheck_day": "取消 Day {n} 的完成状态，会同时删除该天的 {c} 条打卡记录（含心得）。确定吗？",
    "confirm_delete_mock": "确定删除这条 Mock 记录吗？",
    "confirm_delete_mistake": "确定删除这道错题记录吗？",
    "confirm_log_focus": "本次专注用时 {n} 分钟，是否直接记入今日打卡记录？",
    "alert_import_failed": "无法解析该备份文件，请确认它是正确的 JSON 备份。",
    "alert_bad_date": "日期格式不正确，请输入类似 2026-10-15 的日期。",
    "ph_mock_correct": "例如: 49",
    "ph_mock_minutes": "例如: 105",
    "ph_mock_source": "例如: 社区 Mock 1 / AI 原创试卷",
    "ph_mock_notes": "例如：多选漏选；错题集中在 D1 的 hooks 判定和 D4 的 schema nullable 上...",
    "ph_checkin_note": "例如：完成了 D1.5 Hooks 拦截伪代码，理清了 PreToolUse 与 PostToolUse 的触发时机...",
    "ph_mistake_q": "例如：Mock 1 - Q14 或 智能客服退款",
    "ph_mistake_stem": "例如：用户要求退款前必须进行身份校验，如何确保不可绕过？",
    "ph_mistake_my": "例如：选了 B（在 System Prompt 里强调先验密）",
    "ph_mistake_correct": "例如：应选 D（PreToolUse Hook 程序级拦截）",
    "ph_mistake_ref": "例如：总纲 D1.5 Hooks 章节",
    "ph_mistake_refl": "Prompt 是概率性指导，凡涉及钱和安全，必须找程序硬约束！",
    "btn_close": "关闭",
    "title_pomodoro": "打开专注番茄钟",
    "title_export": "导出备份当前学习进度与打卡记录",
    "title_import": "从 JSON 文件恢复进度",
    "title_reset": "重置全部学习与打卡数据",
    "aria_plan_switch": "选择备考计划",
    "aria_tabs": "主功能标签导航",
  ...
  "en": {
    ...
    "stage_name_0": "0. Unstarted",
    "stage_name_1": "1. Concept",
    "stage_name_2": "2. Practice",
    "stage_name_3": "3. Verified",
    "stage_select_aria": "Mastery stage",
    "core_summary_label": "Core Summary: ",
    "no_match_title": "[No Matching Tasks]",
    "no_match_desc": "No tasks found matching \"{kw}\" or the current filter. Try clearing filters.",
    "suggest_minutes": "Suggested {n} mins",
    "note_minutes": "{n} mins",
    "cal_checked_suffix": " (checked in)",
    "today_finished_badge": "Finished",
    "today_finished_status": "Plan Completed",
    "today_finished_title": "Congratulations! {n}-Day Study Plan Completed",
    "today_finished_obj": "Knowledge system fully established! Proceed to the Mock tab for timed simulations and targeted review.",
    "today_finished_out": "Complete at least two 60-question timed mocks with scores >= 80%!",
    "today_finished_btn": "All Plans Completed",
    "plan_heading_7": "7-Day Sprint Study Plan",
    "plan_heading_14": "14-Day Steady Study Plan",
    "plan_progress_pill": "Completed {done} / {total} days",
    "readiness_ready": "Exam Ready (2+ Mocks >= 80%)",
    "readiness_progress": "Readiness: {n}/2 Mocks >= 80%",
    "readiness_ready_short": "Ready",
    "latest_mock": "Latest: {c}/60 ({m}m)",
    "countdown_days": "Exam in: {n} days ({d})",
    "countdown_today": "Exam day is today! Stay calm and confident!",
    "countdown_passed": "Exam date passed ({d}), use \"Set Date\" to edit",
    "mock_default_source": "Timed Mock",
    "mock_meta": "{m} mins · Weakest: {w}",
    "btn_delete": "Delete",
    "mistake_default_qno": "Mistake",
    "mistake_wrong_tag": "[My Answer]",
    "mistake_right_tag": "[Correct]",
    "mistake_reflection_tag": "[Takeaway]",
    "mistake_ref_tag": "[Review]",
    "mistakes_filter_empty": "No mistakes in this category yet. When you miss a question in practice or a mock, click \"+ Add Mistake Review\" above to log it.",
    "all_count": "All ({n})",
    "auto_checkin_note": "Completed Day {n}: {title}",
    "toast_plan_switched": "Switched to the {n}-day study plan",
    "toast_day_checked": "Day {n} checked in! Streak: {s} days",
    "toast_checkin_saved": "Check-in saved! Streak: {s} days",
    "toast_all_done": "Every day in this plan is already checked in!",
    "toast_mock_saved": "Mock saved! Readiness recalculated.",
    "toast_mistake_saved": "Mistake saved to your notebook. Review the root cause often!",
    "toast_exam_date_set": "Target exam date set to {d}",
    "toast_exam_date_cleared": "Target exam date cleared",
    "toast_focus_done": "Completed a {n}-minute focus session!",
    "confirm_uncheck_day": "Unchecking Day {n} will also delete its {c} check-in log(s), including notes. Continue?",
    "confirm_delete_mock": "Delete this mock record?",
    "confirm_delete_mistake": "Delete this mistake record?",
    "confirm_log_focus": "You focused for {n} minutes. Log it as today's check-in?",
    "alert_import_failed": "Could not parse this backup file. Please make sure it is a valid JSON backup.",
    "alert_bad_date": "Invalid date. Please use a date like 2026-10-15.",
    "ph_mock_correct": "e.g. 49",
    "ph_mock_minutes": "e.g. 105",
    "ph_mock_source": "e.g. Community Mock 1 / AI-generated set",
    "ph_mock_notes": "e.g. Missed options on multi-select; mistakes clustered on D1 hooks and D4 nullable schema fields...",
    "ph_checkin_note": "e.g. Wrote D1.5 hook interception pseudocode; clarified when PreToolUse vs PostToolUse fire...",
    "ph_mistake_q": "e.g. Mock 1 - Q14 or Support refund scenario",
    "ph_mistake_stem": "e.g. Identity must be verified before a refund; how do you make that impossible to bypass?",
    "ph_mistake_my": "e.g. Chose B (stress verification in the system prompt)",
    "ph_mistake_correct": "e.g. D (programmatic PreToolUse hook gate)",
    "ph_mistake_ref": "e.g. Blueprint D1.5 Hooks section",
    "ph_mistake_refl": "Prompts are probabilistic guidance; anything involving money or safety needs a programmatic hard constraint!",
    "btn_close": "Close",
    "title_pomodoro": "Open the Pomodoro focus timer",
    "title_export": "Export your study progress and check-ins as a backup",
    "title_import": "Restore progress from a JSON backup",
    "title_reset": "Reset all study and check-in data",
    "aria_plan_switch": "Choose study plan",
    "aria_tabs": "Main sections",
  ...
  "official": [
    {
      ...
      "desc_en": "The authoritative registration page, Exam Guide v1.0 PDF download, and exam policy updates",
      "name_en": "Official Certification Page & Exam Guide"
    },
    {
      "name": "Anthropic Academy 课程总入口",
      "url": "https://anthropic.skilljar.com/",
      "desc": "官方出品的互动学习课程（包含 Building with Claude API、MCP 入门等）",
      "desc_en": "Official interactive courses (including Building with the Claude API, Intro to MCP, and more)",
      "name_en": "Anthropic Academy Course Hub"
    },
    {
      ...
      "desc_en": "Deep dive into subagent isolation, context passing, delegation, and anti-patterns; closely aligned with D1/D5",
      "name_en": "Introduction to Subagents (Official Course)"
    },
    {
      ...
      "desc_en": "Official API docs: stop_reason semantics, prompt engineering guide, and the Message Batches API",
      "name_en": "Claude Platform Docs"
    },
    {
      "name": "Claude Code 官方文档",
      "url": "https://code.claude.com/docs/en/overview",
      "desc": "CLAUDE.md、Rules、Skills、内置工具与 CI/CD 集成权威指南",
      "desc_en": "Authoritative guide to CLAUDE.md, rules, skills, built-in tools, and CI/CD integration",
      "name_en": "Claude Code Docs"
    },
    {
      "name": "Claude Agent SDK 官方文档",
      "url": "https://code.claude.com/docs/en/agent-sdk/overview",
      "desc": "Hooks 拦截器规范、多 Agent 架构契约与最新 Agent 工具使用指南",
      "desc_en": "Hooks, multi-agent architecture contracts, and the latest agent tool-use guidance",
      "name_en": "Claude Agent SDK Docs"
    },
    {
      "name": "Model Context Protocol (MCP) 规范",
      "url": "https://modelcontextprotocol.io/",
      "desc": "MCP 官方协议标准、Resources、Prompts、Tools 与结构化错误响应规范",
      "desc_en": "The official MCP standard: resources, prompts, tools, and structured error responses",
      "name_en": "Model Context Protocol (MCP) Specification"
    }
  ],
  "community": [
    {
      ...
      "desc_en": "Independent community-made 60-question mock exam to practice the 120-minute pace and scenario judgment",
      "name_en": "claudecertificationguide.com Community Mock"
    },
    {
      "name": "Ray 的工作流实操 Skills 库",
      "url": "https://github.com/imraywang/rayskills",
      "desc": "社区优秀的 Agent 工作流可执行实操参考代码，体会工程落地实践",
      "desc_en": "Community reference code for executable agent workflows, showing real engineering practice",
      "name_en": "Ray's Hands-on Workflow Skills Repo"
    },
    {
      ...
      "desc_en": "Community-recommended systematic review videos to build a big-picture mental model",
      "name_en": "YouTube CCAR-F Full Video Playlist"
    },
    {
      ...
      "desc_en": "Dissects common agent deployment failures, tool misrouting, and context overload; hits the core of D1/D2/D5",
      "name_en": "Agent Engineering Anti-Patterns Talk (2026 World's Fair)"
    }
  ]
};
